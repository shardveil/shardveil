...
export const PACK_TIERS: Record<PackTier, { costWei: bigint; cardCount: number; minRarity: CardRarity; dailyLimit: number }> = {
  BASIC:   { costWei: 100n * 10n ** 18n, cardCount: 3,  minRarity: 'COMMON',   dailyLimit: 10 },
  PREMIUM: { costWei: 300n * 10n ** 18n, cardCount: 5,  minRarity: 'UNCOMMON', dailyLimit: 5  },
  ELITE:   { costWei: 750n * 10n ** 18n, cardCount: 5,  minRarity: 'RARE',     dailyLimit: 3  },
  MYTHIC:  { costWei: 2000n * 10n ** 18n, cardCount: 5, minRarity: 'EPIC',     dailyLimit: 1  },
};
