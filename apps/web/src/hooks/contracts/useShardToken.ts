...
const abi = shardTokenAbi;
type ContractAbi = typeof abi;

function useContractAddress() {
  const chainId = useChainId();
  return chainId === ARBITRUM_SEPOLIA_CHAIN_ID
    ? addresses[ARBITRUM_SEPOLIA_CHAIN_ID].shardToken
    : undefined;
}

export function useShardTokenRead<
...
export function useShardTokenWrite() {
  const address = useContractAddress();
...
export function useShardTokenEvents<
...
export { shardTokenAbi as ShardTokenAbi };
export type { ContractAbi as ShardTokenContractAbi };
