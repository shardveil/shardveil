...
const abi = veilTokenAbi;
type ContractAbi = typeof abi;

function useContractAddress() {
  const chainId = useChainId();
  return chainId === ARBITRUM_SEPOLIA_CHAIN_ID
    ? addresses[ARBITRUM_SEPOLIA_CHAIN_ID].veilToken
    : undefined;
}

export function useVeilTokenRead<
...
export function useVeilTokenWrite() {
  const address = useContractAddress();
...
export function useVeilTokenEvents<
...
export { veilTokenAbi as VeilTokenAbi };
export type { ContractAbi as VeilTokenContractAbi };
